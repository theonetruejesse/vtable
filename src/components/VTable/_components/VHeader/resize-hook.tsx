...
/**
 * Hook to handle drag and resize logic for table columns
 *
 * @param table - The TanStack table instance
 * @returns Object containing the resize handler and debug info
 */
...
/**
 * Debugger component to show resize state
 */
export function ResizeDebugger({ debugInfo }: { debugInfo: DebugResizeInfo }) {
